...
module.exports = msgHandler = async (client, message) => {
	...
	case '!stickernobg':
		...
		//untuk api key kalian bisa dapatkan pada website remove.bg
                var result = await removeBackgroundFromImageBase64({ base64img, apiKey: '6Aq63i8gg6fTsF579CajBWKi', size: 'auto', type: 'auto', outFile })
        ...
        /*case '!fb':
            ...
            break*/
        case '!creator':
            client.sendContact(from, '6285860684303@c.us')
            break
        /*case '!ig':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ One Percent Bot Broadcast ]\n\n${msg}`)
            }
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://github.com/brainfr3ze', info)
            break
        case '!snk':
